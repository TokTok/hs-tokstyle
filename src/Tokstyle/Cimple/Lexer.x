...
<0,ppSC>	"__FILE__"				{ mkL IdConst }
<0,ppSC>	"__LINE__"				{ mkL IdConst }
<0,ppSC>	"__cplusplus"				{ mkL IdConst }
<0,ppSC>	"__FreeBSD__"				{ mkL IdConst }
<0,ppSC>	"__linux__"				{ mkL IdConst }
<0,ppSC>	"__sun"					{ mkL IdConst }
