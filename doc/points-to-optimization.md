...
facts for *every node* of *every analyzed context* in `fsCFGCache`.
...
*   **Analysis Phase:** During the global fixpoint phase, *discard* the
...
Implement a differential analysis where only the *changes* (deltas) in a summary
